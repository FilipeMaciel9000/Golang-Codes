...
func main() { //(4)
	...
	//Preste atenção na formatação: três strings diferentes foram criadas e atribuidas para três variáveis diferentes separadas por vírgula;
	...
	//Enquanto fmt.Println(z) mostrará apenas o valor contido da variável z;
	fmt.Printf("%v %v\n", x, y)
	fmt.Println(z)
}
